...
$sor = mysqli_query($baglan,"SELECT a.dok_ismi,a.tur,b.randevu_tarih FROM randevular a INNER JOIN takiprandevu b ON a.id = b.doc_id WHERE a.mus_id='$musid' AND b.mus_id='$musid' AND b.randevu_durum='1' AND b.doc_id='$doc_id'");
